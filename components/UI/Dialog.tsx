...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn('heading-l-text capitalize', className)}
    {...props}
  />
));
